...
export function EmptyState({ onCreateForm }: EmptyStateProps) {
  return (
    <div className="flex-1 flex flex-col items-center justify-center px-4 animate-fade-in animate-slide-up">
      <div className="w-20 h-20 rounded-lg bg-[rgb(var(--primary))/0.1] flex items-center justify-center mb-6">
        <svg className="w-10 h-10 text-[rgb(var(--primary))]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
