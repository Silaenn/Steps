      ...
      <div className="flex items-center justify-center gap-1 sm:gap-2 py-4">
        {Array.from({ length: maxRating }, (_, i) => i + 1).map((star) => (
          <button
            ...
            className={clsx(
              "w-12 h-12 rounded-lg text-xl sm:text-2xl flex items-center justify-center transition-all hover:scale-110 focus:outline-none focus:ring-2 focus:ring-[rgb(var(--primary))/0.4]",
              star <= rating
